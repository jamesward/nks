...
curl -L -o gradle/wrapper/gradle-wrapper.jar https://github.com/jamesward/nks/raw/main/kjs/gradle/wrapper/gradle-wrapper.jar
...
mkdir -p common/src/jsMain/kotlin
...
cat << 'EOF' > web/src/main/kotlin/Main.kt
fun main() {
    println("hello, world")
}
EOF
...
cat << 'EOF' > web/src/main/resources/index.html
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <title>Kotlin Bars</title>
</head>
<body>
    <div id="root"></div>
